---
featureId: "version-5.0.2-module-immortal-game-service-impl"
...
# 5.0.2 · immortal-game-service-impl 模块

Git 版本 5.0.2 中，模块 immortal-game-service-impl 受控识别 23 个文件；内容来自 commit 836abbd7f805 的路径和结构扫描。
