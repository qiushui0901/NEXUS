---
featureId: "version-5.0.2-module-immortal-game-service-api"
...
# 5.0.2 · immortal-game-service-api 模块

Git 版本 5.0.2 中，模块 immortal-game-service-api 受控识别 1 个文件；内容来自 commit 836abbd7f805 的路径和结构扫描。
