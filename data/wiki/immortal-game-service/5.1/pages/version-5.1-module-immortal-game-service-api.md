---
featureId: "version-5.1-module-immortal-game-service-api"
...
# 5.1 · immortal-game-service-api 模块

Git 版本 5.1 中，模块 immortal-game-service-api 受控识别 12 个文件；内容来自 commit f7e0e22bec30 的路径和结构扫描。
...
> Git f7e0e22bec30 的版本证据：immortal-game-service-api/pom.xml；仅记录文件路径和类型，未复制源码正文。
